  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {portfolio.portfolioItems.map((item, index) => (
        <div key={index} className="animate-fade-in-up" style={{ animationDelay: `${index * 0.15}s`, animationFillMode: 'backwards' }}>
          <Card className="bg-card/70 backdrop-blur-sm border-border/50 hover:border-accent/50 hover:scale-[1.02] transition-all duration-300 ease-in-out flex flex-col overflow-hidden h-full">
            <CardHeader>
